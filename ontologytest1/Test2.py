...
# Query for retrieving the range of fields with object property isFieldOn having value 'add_a_member'
query = """
    SELECT ?field ?range
    WHERE {{
...
""".format(instance_uri="http://www.semanticweb.org/anant.sabane01/ontologies/2020/1/untitled-ontology-7#add_a_member")
...
# query = """
#     PREFIX my_ns: <http://www.semanticweb.org/anant.sabane01/ontologies/2020/1/untitled-ontology-7#Add_a_member>
#     SELECT ?field ?action
#     WHERE {
