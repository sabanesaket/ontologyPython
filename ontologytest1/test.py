...
# Query for retrieving the range of fields with object property isFieldOn having value 'add_a_book'
query = """
    SELECT ?field ?range
    WHERE {{
...
""".format(instance_uri="http://www.semanticweb.org/anant.sabane01/ontologies/2020/1/untitled-ontology-7#add_a_book")
...
# query = """
#     PREFIX my_ns: <http://www.semanticweb.org/anant.sabane01/ontologies/2020/1/untitled-ontology-7#Add_a_book>
#     SELECT ?field ?action
#     WHERE {
