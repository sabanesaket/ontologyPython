...
# Query for retrieving the range of fields with object property isFieldOn having value 'Search_catalogue'
query = """
    SELECT ?field ?range
    WHERE {{
...
""".format(instance_uri="http://www.semanticweb.org/anant.sabane01/ontologies/2020/1/untitled-ontology-7#Search_catalogue")
...
# query = """
#     PREFIX my_ns: <http://www.semanticweb.org/anant.sabane01/ontologies/2020/1/untitled-ontology-7#Search_catalogue>
#     SELECT ?field ?action
#     WHERE {
#         my_ns:Add_a_book my_ns:hasField ?field .
#     }
# """
